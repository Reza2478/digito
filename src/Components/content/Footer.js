...
const Footer = () => {
  return (
    <div className="flex flex-col max-w-screen-2xl container bg-white p-8 md:flex-row">
      <div className=" p-8 text-slate-800">
        ...
        <div className="flex items-start justify-between">
          <p className="text-xl leading-10 text-justify">
            دیجی‌ تایز عرضه کننده جدیدترین محصولات الکترونیک نظیر لپ تاپ، گوشی هوشمند و ساعت هوشمند می‌باشد.دیجی تایز افتخار این را داشته که به
      ...
      <div className="justify-center flex flex-col items-center md:items-end p-8">
        <img className="mb-8 max-w-xs rounded-lg" src={Location} alt="" />
        <div className="flex flex-col gap-y-2 text-orange-500">
          <div className="flex items-center justify-center md:justify-end text-lg">
