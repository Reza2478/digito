        ...
        <li className="mb-2" onClick={() => selectHandler("all")}>
          <a href="#/" className="flex items-center rounded-md p-2">
            <span className="relative flex h-5 w-5 rounded-full bg-gray-200">
              <svg xmlns="http://www.w3.org/2000/svg" className={selected === "all" ? "stroke-slate-800 absolute -bottom-1.5 -left-1 h-5 w-5" : "stroke-slate-300 absolute -bottom-1.5 -left-1 h-5 w-5"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
              </svg>
            </span>
            <span className={selected === "all" ? "text-slate-800 mr-3 text-lg" : "text-gray-300 mr-3 text-lg"}>تمام محصولات</span>
          </a>
        </li>
